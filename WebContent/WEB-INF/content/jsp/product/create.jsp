       ...
       <div class="col-xs-12 col-sm-10 col-md-9 ">
		 ...
		 <div class="forms">
		   <s:form action="createProduct" theme="simple" namespace="/product" enctype="multipart/form-data">
		       ...
		       <s:textfield id="product" name="product.productName" class="form-control"/>
		     </div>
		     <div class="form-group">
		   	   <s:label for="product.category"><s:text name="global.product_category"/></s:label>&nbsp;
		   	   <s:fielderror id="categoryError" fieldName="product.category" cssClass="alert alert-danger"/>
		       ...
		       <s:textarea id="description" name="product.description" class="form-control"/>		       
		     </div>
	         ...
	         <s:a href="" id="addDetail" class="btn"><s:text name="global.add_details"/></s:a>
		       ...
		       <s:textfield id="price" class="form-control" name="product.price"/>
		     </div>
		   	 <div class="form-group">
		       <s:submit id="createSubmit" key="global.upload"/>
		     </div>
