 ...
 * redirect to a welcome page based on the user's role.
 * If a welcome page cannot be resolved this way it will delegate to the base class. 
 * 
 *
 */
public class SavedRequestRoleBasedAuthenticationSuccessHandler extends
		SimpleUrlAuthenticationSuccessHandler {
	
	private static final Logger logger = Logger.getLogger(SavedRequestRoleBasedAuthenticationSuccessHandler.class);
	...
	public SavedRequestRoleBasedAuthenticationSuccessHandler(Map<String, String> roleUrls,String defaultTargetUrl) {
		super(defaultTargetUrl);           //Set up back-up url in case url resolution fails.
